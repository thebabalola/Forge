...
export default function ClaimPage() {
  ...
  const handleClaim = async () => {
    ...
    if (!ethers.isAddress(distributorAddress)) return setError("Enter a valid distributor address!");
    ...
    try {
      ...
      if (!storedFiles) throw new Error("No recipient data found. Please upload recipients CSV first.");
      
      const files = JSON.parse(storedFiles);
      if (!files.length) throw new Error("No recipient data found. Please upload recipients CSV first.");
